    ...
    <div className="relative min-h-screen bg-white font-sans dark:bg-zinc-950">
          ...
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            ...
            >
              ...
              <p className="mx-auto mt-6 max-w-2xl text-base text-gray-600 dark:text-gray-400 sm:text-lg lg:mx-0">
                When a Man Walks Into a Room… People Notice His Watch. Your
                watch silently communicates success, confidence, and taste.
              </p>

              <div className="mt-8 flex flex-col items-center justify-center space-y-4 lg:items-start">
                <div className="flex items-end space-x-4">
                  <span className="text-3xl text-red-600 dark:text-red-500 sm:text-4xl font-bold">
                    ₦85,000
                  </span>
                  <span className="text-lg text-gray-400 line-through dark:text-gray-500 sm:text-xl">
                    ₦98,000
                  </span>
                </div>
                <p className="font-bold text-green-600 dark:text-green-400">
                  You Save ₦13,000 Instantly
                </p>
              </div>
              ...
              <div className="mt-8">
                ...
                >
                  Order now Save ₦13,000
                  <ArrowRight className="ml-2 h-5 w-5 transition-transform group-hover:translate-x-1" />
                </button>
                <p className="mt-3 text-sm text-gray-500">
                  Only 17 units remaining today.
                </p>
              </div>
            </motion.div>
          ...
          <div className="bg-gold/10 border-2 border-dashed border-gold p-6 sm:p-10 rounded-xl relative">
            <div className="flex flex-col sm:flex-row gap-8 items-center relative z-10">
              ...
              <div className="flex-1 text-center sm:text-left">
                <h4 className="text-lg font-black text-gold uppercase tracking-wide mb-2">
              ...
              <div className="w-full sm:w-64 shrink-0 aspect-[4/3] relative rounded-xl overflow-hidden border border-[#333]">
                <Image
                  src="/braceletimage.jpeg"
                  alt="Free Premium Bracelet"
                  fill
                  className="object-cover"
                />
              </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mx-auto mt-4 max-w-2xl text-base text-gray-600 dark:text-gray-400 sm:text-lg">
              This Luxury Sports Watch was designed for men who want a powerful,
              modern, high-status look without spending hundreds of thousands.
            </p>
          </div>
                ...
                <div className="flex">
                  ...
                  <div className="ml-4 sm:ml-6">
                    ...
                    <p className="mt-2 text-sm text-gray-600 dark:text-gray-400 sm:text-base">
                      Inspired by some of the most expensive watches in the
                      world, this bold square design immediately gives off a
                      premium luxury look. People will assume it costs far more
          ...
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            ...
            <div className="order-1 lg:order-2">
              ...
              <p className="mt-4 text-base text-gray-600 dark:text-gray-400 sm:text-lg">
                Every detail is crafted to perfection, ensuring you look your
                best while enjoying maximum comfort.
              </p>
              ...
              <ul className="mt-8 space-y-4">
                {[
                  ...
                  <li key={index} className="flex items-center">
                    ...
                    <span className="ml-3 text-base font-medium text-gray-900 dark:text-gray-200 sm:text-lg">
                      {feature}
                    </span>
                  </li>
                ))}
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            <div>
              ...
              <p className="mt-4 text-base text-gray-600 dark:text-gray-400 sm:text-lg">
                Every order comes with everything you need. Perfect for personal
                use or gifting.
              </p>
              ...
              <div className="mt-8 space-y-4 sm:space-y-6">
                <div className="flex items-center rounded-xl border border-gray-200 bg-white p-3 shadow-sm dark:border-zinc-800 dark:bg-zinc-900 sm:p-4">
                  ...
                  <span className="ml-4 text-base font-bold text-gray-900 dark:text-white sm:text-lg">
                    Luxury Sports Watch
                  </span>
                </div>
                <div className="flex items-center rounded-xl border border-gray-200 bg-white p-3 shadow-sm dark:border-zinc-800 dark:bg-zinc-900 sm:p-4">
      ...
      <section className="bg-gray-50 py-16 dark:bg-zinc-900/50 sm:py-24">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mx-auto mt-4 max-w-2xl text-base text-gray-600 dark:text-gray-400 sm:text-lg">
              This watch is one of the fastest-selling luxury accessories right
              now.
            </p>
          </div>
          ...
          <div className="mt-12 grid gap-8 lg:grid-cols-2">
            ...
            <div>
              <div className="relative aspect-[3/4] w-full min-h-[400px] overflow-hidden rounded-xl lg:aspect-auto lg:h-full">
                <Image
                  src="/productimage10.jpeg"
                  alt="Customer Review Shot"
                  fill
                  className="object-cover"
                  referrerPolicy="no-referrer"
                />
      ...
      <section className="py-16 sm:py-24">
        <div className="mx-auto max-w-3xl px-4 text-center sm:px-6 lg:px-8">
          ...
          <p className="mt-4 text-lg font-medium text-red-600 dark:text-red-500 sm:text-xl">
          ...
          <div className="mx-auto mt-8 max-w-md rounded-2xl border-2 border-red-100 bg-white p-6 shadow-2xl dark:border-red-900/30 dark:bg-zinc-900 sm:p-8">
            <p className="text-base font-bold text-gray-500 line-through sm:text-xl">
              Normal Price: ₦98,000
            </p>
            <p className="mt-2 text-4xl font-black text-black dark:text-white sm:text-5xl">
              Today Only:
            </p>
            <p className="mt-4 text-5xl font-black text-red-600 dark:text-red-500 sm:text-6xl">
              🔥 ₦85,000
            </p>
            <p className="mt-4 text-sm font-bold text-green-600 dark:text-green-400 sm:text-base">
              You Save ₦13,000 Instantly
            </p>
          ...
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            <div>
              ...
              <p className="mt-4 text-lg font-medium text-red-100 sm:text-xl">
                Due to the ₦13,000 promo discount, orders are coming in quickly.
                We currently have very limited units remaining.
              </p>

              <div className="mt-8 rounded-xl bg-white p-6 text-center text-black shadow-xl">
                <p className="text-base font-bold uppercase text-red-600 sm:text-lg">
                  ⚠ Stock Remaining Today
                </p>
                <p className="mt-2 font-display text-5xl font-black sm:text-6xl">
                  17
                </p>
                <p className="mt-2 text-xs font-medium text-gray-500 uppercase tracking-widest sm:text-sm">
                  Watches Left
                </p>
              </div>
              ...
              <div className="mt-8 space-y-4 text-base font-medium text-red-100 sm:text-lg">
                ...
                <ul className="space-y-2">
                  <li className="flex items-center">
                    <span className="mr-3 flex h-6 w-6 items-center justify-center rounded-full bg-red-800 text-sm font-bold">
                      X
                    </span>
      ...
      <section
        id="checkout-form"
        className="bg-gray-50 py-16 dark:bg-zinc-900/50 sm:py-24"
      >
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid gap-12 lg:grid-cols-2 lg:items-start">
            <div className="lg:sticky lg:top-24">
              ...
              <div className="mt-8 rounded-xl border border-red-200 bg-white p-6 text-center shadow-xl dark:border-red-900/30 dark:bg-zinc-900 sm:p-8">
                <p className="text-base font-bold text-gray-500 line-through sm:text-lg">
                  Normal Price: ₦98,000
                </p>
                <p className="mt-2 text-3xl font-black text-red-600 dark:text-red-500 sm:text-4xl">
                  Today: ₦85,000
                </p>
            ...
            <div className="mt-8 lg:mt-0">
              <div className="mb-6">
                ...
                <p className="mt-2 text-sm text-gray-600 dark:text-gray-400 sm:text-base">
                  Upgrade your wrist today. Fill the form below to secure your
                  order.
                </p>
              </div>
              <OrderForm />
